      ...
      <ScrollView>
        ...
        <View style={styles.cardContainer}>
          <View
            ...
            <Image source={require("../assets/VISA.png")} style={{ width: 40, height: undefined, aspectRatio: 5 / 2 }}/>
            ...
            {activeCard === 1 ? (
              ...
              <TouchableOpacity onPress={() => setActiveCard(1)}>
                <Image source={require("../assets/Radio2.png")}/>
              </TouchableOpacity>
            )}
          </View>
          <View
            ...
            <Image source={require("../assets/MASTERCARD.png")} style={{ width: 40, height: undefined, aspectRatio: 13 / 10 }}/>
            <Text style={styles.textStyle2}>•••• •••• •••• 87652</Text>
            {activeCard === 2 ? (
              <TouchableOpacity>
                <Image source={require("../assets/Radio.png")}/>
          ...
          <TouchableOpacity style={styles.card1}>
            <Image source={require("../assets/plus.png")} style={{ width: 40, height: undefined, aspectRatio: 13 / 10 }}/>
